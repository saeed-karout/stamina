          ...
          <div className="container mx-auto flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-1/2">
              <h4 className="flex items-center text-orange-500 font-bold text-sm uppercase tracking-wider mb-2">
                <hr className="w-4 border-1 mr-2 border-orange-400" /> Contact
                Us
              </h4>
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                It's never been easier to get in touch with Stamina. Call us,
                use our live chat widget or email, and we'll get back to you as
                soon as possible!
              </p>
              {/* تفاصيل الاتصال */}
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="flex flex-col items-start space-y-3">
                  ...
                  <p className="text-gray-600">
                    Lorem ipsum dolor sit amet, A maxime doloru ...
                  </p>
                </div>
                {/* الشبكات الاجتماعية */}
                <div className="flex flex-col items-start space-y-3">
