    ...
    >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="text-gray-400 space-y-2">
            <li><Link to="/products/lima-mixers" className="hover:text-orange-400">Lima Mixers</Link></li>
            <li><Link to="/products/stamina-mixers" className="hover:text-orange-400">Stamina Mixers</Link></li>
            <li><Link to="/products/ceramics" className="hover:text-orange-400">Ceramics</Link></li>
            <li><Link to="/products/showers" className="hover:text-orange-400">Showers</Link></li>
            <li><Link to="/products/accessories" className="hover:text-orange-400">Accessories</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex">
            <input
              ...
              className="py-2 px-4 w-[90%] mr-3 border  border-gray-300 focus:outline-none"
            />
