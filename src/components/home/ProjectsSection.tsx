// src/components/home/LatestProjectsSection.jsx
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start  mb-8">
          <div className="text-center md:text-left mb-4 md:mb-0">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Watch Our Latest Projects</h2>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          ...
          <div className="relative flex justify-center lg:justify-start">
            <div className="bg-[#474c53]  transform   transition-transform duration-300  shadow-lg w-[80%] sm:w-[60%] lg:w-auto">
              <img src={images} alt="Marble Flooring" className="w-full transform rotate-6 h-96 object-cover " />
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="space-y-10">
              {[
                ...
                <div key={index} className="flex flex-row  items-center justify-between border-b border-gray-600 pb-4">
